            ...
            child: Column(children: [
              ...
              Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Container(
                    ...
                    child: Text("${widget.postJobModel?.title ?? ""}",
                        maxLines: 10,
                ...
                Container(
                    width: 319.h,
                    margin: EdgeInsets.only(left: 31.h, right: 24.h),
                    child: Text("${widget.postJobModel?.description ?? ""}",
                        maxLines: 10,
                        overflow: TextOverflow.ellipsis,
                        style: CustomTextStyles.titleSmallBluegray400
                            .copyWith(height: 1.57))),
                ...
                Container(
                    width: 319.h,
                    margin: EdgeInsets.only(left: 31.h, right: 24.h),
                    child: Text("${widget.postJobModel?.address ?? ""}",
                        maxLines: 10,
                        overflow: TextOverflow.ellipsis,
                        style: CustomTextStyles.titleSmallBluegray400
                            .copyWith(height: 1.57))),
                ...
                Container(
                    width: 319.h,
                    margin: EdgeInsets.only(left: 31.h, right: 24.h),
                    child: Text("${widget.postJobModel?.deadline ?? ""}",
                        maxLines: 10,
                        overflow: TextOverflow.ellipsis,
                        style: CustomTextStyles.titleSmallBluegray400
                            .copyWith(height: 1.57))),
                ...
                Container(
                    width: 319.h,
                    margin: EdgeInsets.only(left: 31.h, right: 24.h),
                    child: Text("${widget.postJobModel?.lowestsalary ?? ""}",
                        maxLines: 10,
                        overflow: TextOverflow.ellipsis,
                        style: CustomTextStyles.titleSmallBluegray400
                            .copyWith(height: 1.57))),
                ...
                Container(
                    width: 319.h,
                    margin: EdgeInsets.only(left: 31.h, right: 24.h),
                    child: Text("${widget.postJobModel?.highestsalary ?? ""}",
                        maxLines: 10,
                        overflow: TextOverflow.ellipsis,
                        style: CustomTextStyles.titleSmallBluegray400
                            .copyWith(height: 1.57))),
                ...
                Container(
                    width: 319.h,
                    margin: EdgeInsets.only(left: 31.h, right: 24.h),
                    child: Text("${widget.postJobModel?.gender ?? ""}",
                        maxLines: 10,
                        overflow: TextOverflow.ellipsis,
                        style: CustomTextStyles.titleSmallBluegray400
                            .copyWith(height: 1.57))),
                ...
                Container(
                    width: 319.h,
                    margin: EdgeInsets.only(left: 31.h, right: 24.h),
                    child: Text("${widget.postJobModel?.experience ?? ""}",
                        maxLines: 10,
                        overflow: TextOverflow.ellipsis,
                        style: CustomTextStyles.titleSmallBluegray400
                            .copyWith(height: 1.57))),
                ...
                Container(
                    width: 319.h,
                    margin: EdgeInsets.only(left: 31.h, right: 24.h),
                    child: Text("${widget.postJobModel?.selectedOption ?? ""}",
                        maxLines: 10,
                        overflow: TextOverflow.ellipsis,
                        style: CustomTextStyles.titleSmallBluegray400
                            .copyWith(height: 1.57))),
                ...
                Container(
                    width: 319.h,
                    margin: EdgeInsets.only(left: 31.h, right: 24.h),
                    child: Text("${widget.postJobModel?.selectedSkills ?? ""}",
                        maxLines: 10,
                        overflow: TextOverflow.ellipsis,
                        style: CustomTextStyles.titleSmallBluegray400
                            .copyWith(height: 1.57))),
                ...
                Container(
                    ...
                    child: Column(children: [
                      ...
                      CustomElevatedButton(
                          text: "Apply Now",
                          onPressed: () async {
                            bool status = await AppFunctions().checkApplication(
                              userId: FirebaseAuth.instance.currentUser!.uid
                                  .toString(),
                              jobId: widget.postJobModel!.id,
                            );

                            if(status == true){
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text('Application is already submitted!'),
                              ...
                              Get.to(() => ApplyJobScreen(
                                jobId: widget.postJobModel!.id,
                                jobTitle: widget.postJobModel!.title,
                                postUserId: widget.postJobModel!.userId,
                              ));
                            }
